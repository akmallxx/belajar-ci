...
<a href="<?= base_url('admin/ketidakhadiran/form') ?>" class="btn btn-primary mb-3"><i class="bi bi-plus-circle"></i> Tambah Data</a>
    ...
    <table class="table table-striped table-bordered" id="datatables">
        ...
        <tbody>
            ...
            foreach ($ketidakhadiran as $kh) : ?>
                <tr>
                    <td><?= $no++ ?></td>
                    <td><?= htmlspecialchars($kh['nama_pegawai']) ?></td>
                    ...
                    <td>
                        ...
                        <?php endif; ?>
                        <a href="<?= base_url('admin/ketidakhadiran/form/' . $kh['id']) ?>" class="badge bg-primary">Edit</a>
                    </td>
                </tr>
            <?php endforeach; ?>
        </tbody>
