...
namespace Modules\Dashboard\Controllers\Pegawai;

use Modules\LokasiPresensi\Controllers\Admin\LokasiPresensi;
...
class Home extends BaseController
{
    public function index()
    {
        ...
        return view('Modules\Dashboard\Views\pegawai\index', $data);
    }
    ...
    public function edit()
    {
        ...
        return view('Modules\Pegawai\Views\pegawai\edit', $data);
    }
    ...
    public function presensi_masuk()
    {
        ...
        if ($longitude_pegawai < 1 && $latitude_pegawai < 1) {
            ...
            session()->setFlashdata('saText', "Mohon izinkan akses lokasi anda untuk melakukan dat_presensi.");
        ...
        if ($jarakPegawai <= $radius) {
            ...
            return view('Modules\Dashboard\Views\pegawai\ambil_foto', $data);
        } else {
            session()->setFlashdata('saIcon', 'error');
            session()->setFlashdata('saTitle', "Gagal melakukan presensi masuk!");
            session()->setFlashdata('saText', "Anda berada " . number_format($jarakPegawai - $radius) . " meter diluar radius dat_presensi.");
    ...
    public function presensi_masuk_aksi()
    {
        ...
        if ($db->transStatus() === FALSE) {
            ...
            session()->setFlashdata('saText', "Gagal melakukan dat_presensi.");
            return redirect()->to(base_url('home'));
        } else {
    ...
    public function presensi_keluar($id)
    {
        ...
        if ($jarakPegawai <= $radius) {
            ...
            return view('Modules\Dashboard\Views\pegawai\ambil_foto_keluar', $data);
        } else {
            session()->setFlashdata('saIcon', 'error');
            session()->setFlashdata('saTitle', "Gagal melakukan presensi keluar!");
            session()->setFlashdata('saText', "Anda berada " . number_format($jarakPegawai - $radius) . " meter diluar radius dat_presensi.");
