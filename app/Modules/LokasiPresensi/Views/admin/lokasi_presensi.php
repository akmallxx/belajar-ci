...
<a href="<?= base_url('admin/lokasi_presensi/form') ?>" class="btn btn-primary"><i class="bi bi-plus-circle"></i> Tambah Data</a>
    ...
    <tbody>
        ...
        foreach ($lokasi_presensi as $lk): ?>
            <tr>
                ...
                <td>
                    <a href="<?= base_url('admin/lokasi_presensi/form/' . $lk['id']) ?>" class="badge bg-primary">Edit</a>
