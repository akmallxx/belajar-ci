...
namespace Modules\Pegawai\Controllers\Api;
...
class Pegawai extends ResourceController
{
    ...
    public function index()
    {
        ...
        $pegawai = $this->pegawaiModel
            ->select('mst_pegawai.*, mst_users.username, mst_users.password, mst_users.role')
            ->join('mst_users', 'mst_users.id_pegawai = mst_pegawai.id', 'left')
            ->findAll();
    ...
    public function show($id = null)
    {
        ...
        $pegawai = $this->pegawaiModel
            ->select('mst_pegawai.*, mst_users.username, mst_users.role, mst_users.password')
            ->join('mst_users', 'mst_users.id_pegawai = mst_pegawai.id', 'left')
    ...
    public function create()
    {
        ...
        $rules = [
            'username' => 'required|alpha_numeric|is_unique[mst_users.username]',
            'password' => 'required',
            'jabatan' => 'required',
