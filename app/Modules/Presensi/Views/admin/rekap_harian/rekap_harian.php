...
<a href="<?= base_url('admin/rekap_harian/form') ?>" class="btn btn-primary mb-3"><i class="bi bi-plus-circle"></i> Tambah Data</a>
            ...
            foreach ($rekap_harian as $rh) : ?>
                <tr>
                    ...
                    <td>
                        ...
                        <a href="<?= base_url('admin/rekap_harian/form/' . $rh['id']) ?>" class="badge bg-primary">Edit</a>
