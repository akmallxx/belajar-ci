...
namespace Modules\Presensi\Controllers\Pegawai;
...
class RekapPresensi extends BaseController
{
    ...
    public function index()
    {
        ...
        $presensiData = $this->presensiModel
            ->select('dat_presensi.*, mst_pegawai.nip, mst_pegawai.nama')
            ->join('mst_pegawai', 'mst_pegawai.id = dat_presensi.id_pegawai')
            ->where('dat_presensi.id_pegawai', $pegawai_id)
        ...
        return view('Modules\Presensi\Views\pegawai\rekap_presensi\rekap_presensi', $data);
    }
