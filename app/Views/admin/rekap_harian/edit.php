    ...
    <div class="card-body">
        <form method="post" action="<?= base_url('admin/rekap_harian/update/' . $rekap_harian['id']) ?>">
            ...
            <div class="input-style-1">
                ...
                <input type="date" class="form-control" name="tanggal_masuk" value="<?= $rekap_harian['tanggal_masuk'] ?>" required />
            </div>
            <div class="input-style-1">
            ...
            <div class="input-style-1">
                ...
                <input type="date" class="form-control" name="tanggal_keluar" value="<?= $rekap_harian['tanggal_keluar'] ?>" required />
            </div>
            <div class="input-style-1">
